package com.lesofn.archsmith.common.utils;
...
public class ServletHolderUtil {
    ...
    /**
     * 获取仅含有项目根路径的url 比如 localhost:8080/archsmith/user/list 返回 localhost:8080/archsmith
     *
     * @return localhost:8080/archsmith
     */
