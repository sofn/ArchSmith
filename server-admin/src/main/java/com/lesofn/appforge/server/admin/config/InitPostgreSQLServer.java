...
public class InitPostgreSQLServer
    ...
    private static final String DB_USER = "appforge";
    private static final String DB_PASSWORD = "appforge";
    ...
    public void initialize(ConfigurableApplicationContext applicationContext) {
        ...
        String pgEnabled = env.getProperty("app-forge.embedded.postgresql", "false");
        ...
        try {
            ...
            userContainer =
                    new PostgreSQLContainer<>(POSTGRES_IMAGE)
                            .withDatabaseName("appforge_user")
            ...
            taskContainer =
                    new PostgreSQLContainer<>(POSTGRES_IMAGE)
                            .withDatabaseName("appforge_task")
                            .withUsername(DB_USER)
                            .withPassword(DB_PASSWORD);
            taskContainer.start();
