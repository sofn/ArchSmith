...
import static com.lesofn.archsmith.infrastructure.auth.errors.AdminAuthErrorCode.USER_AUTHFAIL;
...
import com.lesofn.archsmith.infrastructure.auth.provider.DefaultUserProvider;
import com.lesofn.archsmith.infrastructure.auth.provider.UserProvider;
import com.lesofn.archsmith.infrastructure.auth.spi.AuthSpi;
import com.lesofn.archsmith.infrastructure.auth.spi.BasicAuthSpi;
import com.lesofn.archsmith.infrastructure.auth.spi.GuestAuthSpi;
import com.lesofn.archsmith.infrastructure.auth.spi.NullAuthSpi;
import com.lesofn.archsmith.infrastructure.frame.spring.ApplicationContextHolder;
import java.util.*;
